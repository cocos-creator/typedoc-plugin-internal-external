...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "typedoc/dist/lib/converter/components", "typedoc/dist/lib/converter/converter", "typedoc/dist/lib/converter/factories/comment", "typedoc/dist/lib/converter/plugins/CommentPlugin", "typedoc/dist/lib/models/reflections", "typedoc/dist/lib/models/reflections/abstract", "typedoc/dist/lib/utils/options"], factory);
    }
    ...
    let InternalExternalPlugin = InternalExternalPlugin_1 = class InternalExternalPlugin extends components_1.ConverterComponent {
        ...
        onFileBegin(context, reflection, node) {
            if (!node)
                return;
            // Look for @internal or @external
            let comment = comment_1.getRawComment(node);
